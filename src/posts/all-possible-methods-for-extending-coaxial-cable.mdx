...
moddate: 2021-04-14T13:13:07.336Z
tableofcontent: true
...
sidebar:
  stoc:
    - level: false
      name: "How to extend the coaxial cable? "
    - level: true
      name: "Step#1: Measure the Distance "
    - level: true
      name: "Step#2: Prepare Your Cables "
    - level: true
      name: "Step#3: Continue the Process "
    - level: true
      name: "Step#4: Connect the Destination "
    - level: false
      name: "Final Verdict "
  stitle: ""
---
...
[Coaxial cable](https://trustedperks.com/best-coaxial-cable-for-internet/) has the following parts:
...
Make sure that all the [connections](https://trustedperks.com/best-ethernet-cables-for-gaming/) are safe, firm, and extremely secure. To check whether the extension has remained successful, power-up your TV and run a channel scan. Examine whether you are able to view all the channels with the desired video and audio quality. 
